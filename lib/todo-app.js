...
function update(action, model, data) {
  ...
  switch (action) {
    case "ADD":
      new_model = addTodoItem(new_model, model, data);
      break;
    case "TOGGLE":
      new_model = toggle(new_model, data);
      break;
    case "TOGGLE_ALL":
      new_model = toggleAll(new_model, data);
      break;
    case "DELETE":
      new_model = deleteTodoItem(new_model, data);
      break;
    case "EDIT":
      new_model = editTodoItem(new_model, data);
      break;
    case "SAVE":
      new_model = saveTodoItem(new_model);
      break;
    case "CANCEL":
      new_model = cancelTodoItem(new_model);
      break;
    case "CLEAR_COMPLETED":
      new_model = clearCompletedTodoItems(new_model);
      break;
    case "ROUTE":
      new_model = setRouteWithHash(new_model);
      break;
    default:
      return model;
  }
